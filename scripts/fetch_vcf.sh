...
WORMVCF="7.2.0/worm-latest.vcf.gz"
ZEBRAFISHVCF="7.2.0/zebrafish-latest.vcf.gz"
FLYVCF="7.2.0/fly-latest.vcf.gz"
MOUSEVCF="7.2.0/mouse-latest.vcf.gz"
RATVCF="7.2.0/rat-latest.vcf.gz"
...
HTPWORMVCFPATH="7.2.0/HTPOSTVEPVCF_WB_latest.vcf.gz"
HTPZEBRAFISHVCFPATH="7.2.0/HTPOSTVEPVCF_ZFIN_latest.vcf.gz"
HTPFLYVCFPATH="7.2.0/HTPOSTVEPVCF_FB_latest.vcf.gz"
HTPRATVCFPATH="7.2.0/HTPOSTVEPVCF_RGD_latest.vcf.gz"
HTPYEASTVCFPATH="7.2.0/HTPOSTVEPVCF_SGD_latest.vcf.gz"
