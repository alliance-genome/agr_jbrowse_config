...
WORMVCF="5.1.1/worm-latest.vcf.gz"
ZEBRAFISHVCF="5.1.1/zebrafish-latest.vcf.gz"
FLYVCF="5.1.1/fly-latest.vcf.gz"
MOUSEVCF="5.1.1/mouse-latest.vcf.gz"
RATVCF="5.1.1/rat-latest.vcf.gz"
...
HTPWORMVCFPATH="5.1.1/HTPOSTVEPVCF_WB_latest.vcf.gz"
HTPZEBRAFISHVCFPATH="5.1.1/HTPOSTVEPVCF_ZFIN_latest.vcf.gz"
HTPFLYVCFPATH="5.1.1/HTPOSTVEPVCF_FB_latest.vcf.gz"
#HTPMOUSEVCFPATH="5.0.0/HTPOSTVEPVCF_MGI_latest.vcf.gz"
HTPRATVCFPATH="5.1.1/HTPOSTVEPVCF_RGD_latest.vcf.gz"
HTPYEASTVCFPATH="5.1.1/HTPOSTVEPVCF_SGD_latest.vcf.gz"
