...
WORMVCF="8.0.0/worm-latest.vcf.gz"
ZEBRAFISHVCF="8.0.0/zebrafish-latest.vcf.gz"
FLYVCF="8.0.0/fly-latest.vcf.gz"
MOUSEVCF="8.0.0/mouse-latest.vcf.gz"
RATVCF="8.0.0/rat-latest.vcf.gz"
...
HTPWORMVCFPATH="8.0.0/HTPOSTVEPVCF_WB_latest.vcf.gz"
HTPZEBRAFISHVCFPATH="8.0.0/HTPOSTVEPVCF_ZFIN_latest.vcf.gz"
HTPFLYVCFPATH="8.0.0/HTPOSTVEPVCF_FB_latest.vcf.gz"
HTPRATVCFPATH="8.0.0/HTPOSTVEPVCF_RGD_latest.vcf.gz"
HTPYEASTVCFPATH="8.0.0/HTPOSTVEPVCF_SGD_latest.vcf.gz"
