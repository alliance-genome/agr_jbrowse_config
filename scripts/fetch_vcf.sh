...
HTPWORMVCFPATH="4.2.0/HTPOSTVEPVCF_WB_latest.vcf.gz"
HTPZEBRAFISHVCFPATH="4.2.0/HTPOSTVEPVCF_ZFIN_latest.vcf.gz"
HTPFLYVCFPATH="4.2.0/HTPOSTVEPVCF_FB_latest.vcf.gz"
HTPMOUSEVCFPATH="4.2.0/HTPOSTVEPVCF_MGI_latest.vcf.gz"
HTPRATVCFPATH="4.2.0/HTPOSTVEPVCF_RGD_latest.vcf.gz"
HTPYEASTVCFPATH="4.2.0/HTPOSTVEPVCF_SGD_latest.vcf.gz"
