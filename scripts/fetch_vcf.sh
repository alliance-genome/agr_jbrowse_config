...
WORMVCF="7.0.0/worm-latest.vcf.gz"
ZEBRAFISHVCF="7.0.0/zebrafish-latest.vcf.gz"
FLYVCF="7.0.0/fly-latest.vcf.gz"
MOUSEVCF="7.0.0/mouse-latest.vcf.gz"
RATVCF="7.0.0/rat-latest.vcf.gz"
